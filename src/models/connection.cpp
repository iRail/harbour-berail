...
Connection::Connection(int id, Stop* fromStation, Stop* toStation, Disturbances* alerts, Disturbances* remarks, Occupancy occupancy, int duration, QList<Via*> vias, QDateTime timestamp)
{
    this->setId(id);
